...
export function Hero() {
  return (
    <section className="w-full flex justify-center">
      <div
        className=" w-[100%]  max-w-[1200px] bg-white rounded-lg px-4 py-8 sm:px-6 lg:px-10 lg:py-10 
        flex flex-collg:flex-row items-center justify-between gap-8" >
        <div
          className=" w-full max-w-[500px] space-y-6 text-center lg:text-left ">
          <Presentation />

          <Button className="bg-[var(--yellow)] text-black hover:opacity-90 px-6 py-2">
